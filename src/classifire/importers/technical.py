...
PENDING_REVIEW_SEARCH_ELIGIBILITY = "EXCLUDE_PENDING_TECHNICAL_REVIEW"
        ...
        with path.open(encoding="utf-8") as handle:
            for line in handle:
                ...
                record = TechnicalVariant(
                    ...
                    service_material=(
                        row.get("Service_Material") or row.get("Canonical_Service_Material")
                    ),
                    ...
                    permitted_service_quantity=(
                        str(row.get("Permitted_Service_Quantity") or "") or None
                    ),
                    insulation_type=row.get("Insulation_Type"),
                    insulation_thickness_mm=_decimal(row.get("Insulation_Thickness_mm")),
                    substrate_type=(
                        row.get("Substrate_Type") or row.get("Canonical_Substrate_Family")
                    ),
