# TOOLS.md — CLASSIFIRE Commercial Engine
...
These tools are retained for the explicit `full-controlled-write` profile.
They are not registered or granted by the Phase 8 admission-only profile.
