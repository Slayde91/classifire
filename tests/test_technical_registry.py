...
def test_package_15_is_identified_as_firefly_library() -> None:
    ...
    assert library.technical_library_id == "TECHLIB-FIREFLY-P15"
...
def test_registry_can_hold_multiple_independent_libraries() -> None:
    firefly = _release("TECHLIB-FIREFLY-P15", "TECHLIBREL-FIREFLY-2.13", "2.13-runtime")
...
def test_registry_rejects_duplicate_library_release_members() -> None:
    first = _release("TECHLIB-FIREFLY-P15", "REL-A", "1")
    second = _release("TECHLIB-FIREFLY-P15", "REL-B", "2")
...
def test_library_lookup_is_explicit_and_fail_closed() -> None:
    assert technical_library_by_id("TECHLIB-FIREFLY-P15") is FIREFLY_TECHNICAL_LIBRARY
