"""Retain Draft work-photo evidence separately from inspection authority."""
...
revision = "0051_draft_work_photos"
down_revision = "0050_draft_work_records"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint("stored_file_id", name="uq_draft_work_photo_source_file"),
        sa.CheckConstraint(
...
def downgrade() -> None:
    raise RuntimeError("Retained Draft work photos cannot be downgraded")
