...
from .draft_scope_ui import Db, _form_values, _import_session, _native_proposal_binding, _payload
...
def preview(request: Request, db: Db, draft_id: str, source_id: str, form: FormData):
    ...
    try:
        native_history.prepare_review_link(
            ...
            action="propose_word_scope", source_id=source_id, settings=get_settings(),
        )
