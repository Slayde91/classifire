    ...
    def as_manifest(self) -> dict[str, Any]:
        return {
            ...
            "libraries": [
                ...
                for item in sorted(self.library_releases, key=lambda row: row.technical_library_id)
            ],
        }


FIREFLY_TECHNICAL_LIBRARY = TechnicalLibraryDefinition(
    technical_library_id="TECHLIB-FIREFLY-P15",
    ...
    system_categories=("service_penetrations", "fire_seals", "barrier_penetrations"),
)
