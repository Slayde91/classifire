...
| Locally validated increment; publication pending | Multiple exact register row reviews and forward ProjectPackage v6 save/reopen/import/re-export. Existing models and human gates retained; no production phase exit. See [current evidence](./PROJECT_STATE.md) and [contract](./MULTI_REVIEW_PROJECT_PACKAGES.md) |
