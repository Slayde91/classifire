...
ENTITY_EVIDENCE_SCHEMAS = (ENTITY_EVIDENCE_SCHEMA_VERSION, XLSX_EVIDENCE_SCHEMA_VERSION)
...
def validate_evidence_refs(envelope: dict[str, Any]) -> None:
    ...
    for ref in refs:
        ...
        if xlsx:
            ...
            if envelope["schema_version"] != XLSX_EVIDENCE_SCHEMA_VERSION or not entity:
