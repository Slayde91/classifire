...
**Architecture version:** 5.41 - governed quantities and candidate MCP T9/roster/recipe-link parity.
...
Stacked PR #236 reuses the same boundary for bounded T6 recipe-link history and exact
integrity-checked reads. It preserves legacy UI ordering and adds no write or authority.
...
## PR #236 candidate client amendment: read-only T6 recipe-link history
