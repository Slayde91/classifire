...
def test_client_to_human_to_saved_draft_and_exact_package(client_case):
    ...
    with TestClient(case.scope.app, base_url="https://testserver") as client:
        ...
        assert names == {
            ...
            "read_draft_scope",
            "upload_draft_pdf",
            "upload_draft_scope_xlsx",
            "list_draft_scope_xlsx_sources",
            "scan_draft_scope_xlsx",
            "read_draft_scope_xlsx_rows",
            "read_draft_scope_xlsx_image",
            "preview_draft_scope_xlsx_mapping",
