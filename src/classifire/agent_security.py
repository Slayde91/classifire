...
AGENT_SCOPE_MAP: dict[str, set[str]] = {
    ...
    "cf-physical-model": {"health:read", "workflow:read", "physical:read"},
    "cf-technical-system": {"health:read", "workflow:read", "technical:search"},
    "cf-commercial-engine": {"health:read", "workflow:read", "commercial:recommend"},
    "cf-validator": {"health:read", "workflow:read", "validation:run"},
