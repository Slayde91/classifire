...
| Technical-document review separation | **Current-branch candidate** | New Draft or Rejected source documents must be submitted for review, then independently approved or rejected through the existing Approval record before they can carry an approved status. It does not create a migration, canonical authority, or complete source-lineage governance. |
