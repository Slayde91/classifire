...
| --- | --- | --- |
| Shared main | PR #83 merged the current browser, diagnostic, containment-test, and technical-activation safeguards at `ac7de2c`; PR #84 reconciled their status documentation. PRs #86, #88, and #90 then narrowed the technical-source review and reuse boundary; PR #91 (`cf12ed5`) rechecks that source immediately before linked-variant activation; PR #93 (`143c5b5`) makes new technical imports Draft-only and runtime-ineligible; PR #95 requires an active pinned technical release; and PR #96 (`2dca286`) rejects release manifests containing missing or inactive variants. It also contains PR #80's bounded v2 assessment/review contract, PR #81's project-owned report-evidence adapter/startup guard and PostgreSQL CI service, and PR #82's packaged migrations plus production schema-readiness boundary. Alembic has the single `0011_report_evidence_locators` head. | The merges are source publication only; they do not approve a live report run or canonical state change. |
| GitHub validation | The `CLASSIFIRE pull request validation` workflow completed successfully for PR #81's final head `4ebc531`, PR #82's final head `9ad6ca7`, PR #83's final head `70f8df5`, PR #84's final head `828076c`, PR #91's final head `3777dea`, PR #93's final head `7b63a9f`, PR #95's final head `758ba46`, and PR #96's final head `d140898`. PR #83 completed in 2m13s after focused/local full-suite validation; PRs #84 and #91 completed in 1m37s; PR #93 completed in 1m59s; PR #95 and PR #96 completed successfully before their respective merges. | The configured disposable PostgreSQL URL enabled the shared-byte quarantine/read race. CI evidence is not deployment or live-report evidence. |
