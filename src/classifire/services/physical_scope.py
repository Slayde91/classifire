...
from ..canonical_models import ServiceOpeningLink
...
def assess_physical_model_completeness(
    ...
    for opening in openings:
        ...
        # Service-free scope is valid only when the Opening is explicitly classified
        # as a blank opening/core hole. A service penetration still requires at least
        # one canonical ServiceOpeningLink.
        service_relationship_complete = blank_opening or service_link_count > 0
        if service_link_count == 0 and not blank_opening:
