...
**Verified shared-main code baseline:** PR #91 (`cf12ed5`) extended the
technical-activation safeguard: a linked technical source must still be clean,
immutable, and byte-for-byte unchanged when activation is decided. It builds on
