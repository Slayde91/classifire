...
**Working branch:** `gpt/phase8-android-admission-signing-local`
**Merged base:** `e2f646b` (`origin/main`, merged Phase 8 PR #25)
**Current scope:** local implementation and verification of the offline Android admission signer.
